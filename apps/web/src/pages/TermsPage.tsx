  ...
  return (
    <div className="px-6 pt-8 pb-6">
      ...
      <div className="text-muted-foreground space-y-6 text-sm leading-relaxed">
        <p>
          OmNomNom is a personal project, not a commercial product. These terms exist so it's clear
        ...
        <section className="space-y-1">
          ...
          <p>
            Calorie, macro, and score calculations are estimates based on formulas (Mifflin-St Jeor
            for BMR, standard activity multipliers) and the nutrition data available for each food —
            they can be wrong, especially for AI-identified meals. Nothing in this app is medical,
            dietary, or health advice; talk to a qualified professional for that.
          </p>
        </section>
        ...
        <section className="space-y-1">
          ...
          <p>
            ...
            response time. Use the data export in Settings periodically if you want your own backup.
          </p>
        </section>
        ...
        <section className="space-y-1">
          ...
          <p>
            Meal photo recognition uses OpenAI's Vision API, food data comes from OpenFoodFacts and
            the USDA, and reminders are delivered through OneSignal. Each operates under its own
            terms; this app has no control over their availability or accuracy.
          </p>
        </section>
