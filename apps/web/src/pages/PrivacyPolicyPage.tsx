    ...
    <div className="px-6 pt-8 pb-6">
      ...
      <div className="text-muted-foreground space-y-6 text-sm leading-relaxed">
        ...
        <section className="space-y-1">
          <h2 className="text-foreground text-base font-semibold">What's stored</h2>
          <p>
        ...
        <section className="space-y-1">
          <h2 className="text-foreground text-base font-semibold">Food search</h2>
          <p>
        ...
        <section className="space-y-1">
          <h2 className="text-foreground text-base font-semibold">Who can see it</h2>
          <p>
